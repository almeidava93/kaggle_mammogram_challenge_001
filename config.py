...
class MammogramClassifierConfig(BaseModel):
    ...
    img_size: int = Field(..., description="Image size")
    ...
    remove_dark_pixels: bool = Field(False, description="Remove dark pixels from images")
    ...
    num_img_channels: int = Field(..., description="Number of image channels for CNN")
    num_img_init_features: int = Field(..., description="Number of initial features for CNN")
